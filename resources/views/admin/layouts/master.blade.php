...
<head>
  ...
  <title>Cofe | @yield('title')</title>

  <!-- Google Font: Source Sans Pro -->
  <link rel="stylesheet" href="{{asset('admin_asset/https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback')}}">
  <!-- Font Awesome Icons -->
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{route('index')}}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Cofe Dashboard</span>
    </a>
